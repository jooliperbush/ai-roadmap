...
export function page(title: string, ctx: NavContext, body: Raw): string {
  const shell = ctx.email
    ? html`<a class="skip-link" href="#main-content">Skip to content</a> <header class="topbar"> <a class="brandmark" href="/" ><span class="mark" aria-hidden="true">◧</span ><span class="wordmark">Miscited</span></a > <div class="promise">${PROMISE}</div> ${identity(ctx)} </header> <nav class="mainnav" aria-label="Workspace"> ${NAV.map(
        ([key, href, label]) =>
